...
class TestSolution(unittest.TestCase):
    ...
    def test_get_2nd_element_private(self):

        ans = get_2nd_element([0, 200, 300, 400])
    ...
    def test_add_tuple_elements_private(self):

        ans = add_tuple_elements((9, 2))
    ...
    def test_get_age_and_dob_private(self):

        adict = {'name': 'Juliet Capulet', 'age': 30, 'DOB': '04/30/1594'}

        ans1, ans2 = get_age_and_dob(adict)

        self.assertEqual(ans1, 30)
        self.assertEqual(ans2, '04/30/1594')
